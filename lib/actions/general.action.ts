...
// Helper function for creating feedback prompt
function createFeedbackPrompt(formattedTranscript: string): string {
  return `
...
// Existing createFeedback function
export async function createFeedback(params: CreateFeedbackParams) {
  ...
  try {
    ...
    const feedbackPrompt = createFeedbackPrompt(formattedTranscript);
    ...
    // Validate feedback data before inserting into DB
